...
public class OrderFragment2 extends BaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            mIntentUrl = new URL(MyApplication.getIdent().getOrderUrl());
        ...
        view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_order2, null);
    ...
    private void init() {
        ...
        mWebView.setWebChromeClient(new com.tencent.smtt.sdk.WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType) {
                ...
                OrderFragment2.this.uploadFile = uploadFile;
            ...
            public boolean onShowFileChooser(com.tencent.smtt.sdk.WebView webView,
                ...
                OrderFragment2.this.uploadFiles = filePathCallback;
                openFileChooseProcess();
                return true;
            }
        });
        ...
        if (mIntentUrl == null) {
            new AlertDialog.Builder(getActivity()).setTitle("提示").setMessage("您未绑定，请前往绑定页面绑定")
