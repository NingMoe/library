...
public class MyRatioLinearLayout extends LinearLayout {

    //宽与长之比
    private float ratio = -1;

    public MyRatioLinearLayout(Context context) {
        super(context);
    }

    public MyRatioLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MyRatioLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
