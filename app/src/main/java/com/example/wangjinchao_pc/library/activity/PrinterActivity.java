...
//http://cprint.unifound.net//api/client/Scan/Download?dwJobId=137739
    ...
    private static String mHomeUrl = "http://cprint.unifound.net/client/help.html";
    ...
    private void init() {
        ...
        mWebView.setWebChromeClient(new com.tencent.smtt.sdk.WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType) {
                ...
                PrinterActivity.this.uploadFile = uploadFile;
            ...
            public boolean onShowFileChooser(com.tencent.smtt.sdk.WebView webView,
                ...
                PrinterActivity.this.uploadFiles = filePathCallback;
                openFileChooseProcess();
                return true;
            }
        });
